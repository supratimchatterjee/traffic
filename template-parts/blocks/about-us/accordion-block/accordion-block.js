  ...
  $.fn.navAccordion = function(options, callback){
    this.each(function(){
      ...
      var settings = $.extend({
        ...
        buttonWidth: "0%",  //Width of accordion expand/collapse button as a percentage or pixels
...
jQuery(document).ready(function(){
      jQuery('.why_accro').navAccordion({
        expandButtonText: '<i class="fa fa-chevron-down" aria-hidden="true"></i>',  //Text inside of buttons can be HTML
        collapseButtonText: '<i class="fa fa-chevron-up" aria-hidden="true"></i>'
      }, 
      function(){
 ...
 (function($){
    ...
    var initializeBlock = function( $block ) {
     $block.find('.why_accro').navAccordion({
        expandButtonText: '<i class="fa fa-chevron-down" aria-hidden="true"></i>',  //Text inside of buttons can be HTML
        collapseButtonText: '<i class="fa fa-chevron-up" aria-hidden="true"></i>'
      });     
    }
    ...
    if( window.acf ) {
        window.acf.addAction( 'render_block_preview/type=accordion-section', initializeBlock );
    }
